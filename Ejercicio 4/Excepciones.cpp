...
public:
    FechaInvalidaException() : std::runtime_error("Fecha invalida. Debe ser en formato dd/mm/aaaa.") {}
};

class EstadoInvalidoException : public std::runtime_error {
public:
    EstadoInvalidoException() : std::runtime_error("Estado invalido. Solo se permite: asistio, falta, tardanza.") {}
};
...
void registrarAsistencia(Estudiante& estudiante) {
    ...
    try {
        ...
        validarFecha(nuevaAsistencia.fecha);
        ...
        validarEstado(nuevaAsistencia.estado);
